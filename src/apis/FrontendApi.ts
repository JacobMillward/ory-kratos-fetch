...
export class FrontendApi extends runtime.BaseAPI {
     ...
     */
    async createNativeRegistrationFlowRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RegistrationFlow>> {
        const queryParameters: any = {};
     ...
     * Create Registration Flow for Native Apps
     */
    async createNativeRegistrationFlow(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RegistrationFlow> {
        const response = await this.createNativeRegistrationFlowRaw(initOverrides);
        return await response.value();
    }
